...
For its implementation, soiltestR brinfs the function named `modALCC()` that produces the estimation of critical soil test values (CSTV) for a target relative yield with confidence intervals at adjustable confidence levels. <br/>
