...
The `soiltestcorr` package is a collection of functions intended to contribute to reproducible correlation analysis between crop relative yield (ry) and soil test values (stv). This is a strategic collaborative initiative from the Fertilizer Recommendation Support Tool ([FRST](http://www.soiltestfrst.org/)) and the Feed the Future Innovation Lab for Collaborative Research on Sustainable Intensification ([SIIL](https://digitalconsortium.wixsite.com/dgfsc)) projects. <br/> 
