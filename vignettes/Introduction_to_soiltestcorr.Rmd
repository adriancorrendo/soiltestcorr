...
# Data 2
fit_example_2 = soiltestcorr::mod_alcc(data = data_2, RY = RY, STV = STV, target=90, confidence = 0.95)
...
linear_plateau_example_3 = soiltestcorr::linear_plateau(data = data_3, RY = RY, STV = STK, plot = FALSE)
