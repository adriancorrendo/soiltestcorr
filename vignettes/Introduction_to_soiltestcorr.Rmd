...
This tutorial is intended to assist on the use of the available functions from the `soiltestcorr` package for the analysis of relationships between relative yield (RY) and soil test values (STV). <br/>
...
cate_nelson_1965_example_2 = soiltestcorr::cate_nelson_1965(data = data_2, RY = RY, STV = STV, target=90, tidy = FALSE, plot = FALSE)

cate_nelson_1965_example_2

cate_nelson_1965_example_3 = soiltestcorr::cate_nelson_1965(data = data_3, RY = RY, STV = STK, target=95, tidy = TRUE, plot = FALSE)
...
cate_nelson_1971_example_2 = soiltestcorr::cate_nelson_1971(data = data_2, RY = RY, STV = STV, tidy = TRUE, plot = FALSE)

cate_nelson_1971_example_2

cate_nelson_1971_example_3 = soiltestcorr::cate_nelson_1971(data = data_3, RY = RY, STV = STK, tidy = TRUE, plot = FALSE)
...
linear_plateau_example_3_list = soiltestcorr::linear_plateau(data = data_3, RY = RY, STV = STK, 
                                                        tidy = FALSE, plot = FALSE)

linear_plateau_example_3_list

linear_plateau_example_3_tidy = soiltestcorr::linear_plateau(data = data_3, RY = RY, STV = STK, 
...
quadratic_plateau_example_3 = soiltestcorr::quadratic_plateau(data = data_3, RY = RY, STV = STK, 
...
soiltestcorr::linear_plateau(data = data_3, RY = RY, STV = STK, plot = TRUE, resid = TRUE)
