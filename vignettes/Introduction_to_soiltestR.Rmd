...
This tutorial is intended to assist on the use of the available functions from the `soiltestR` package for the analysis of relationships between relative yield (RY) and soil test values (STV). <br/>

## 1. Installation

You can install the development version of soiltestR from [GitHub](https://github.com/adriancorrendo/soiltestR) with:
